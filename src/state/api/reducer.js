...
export const api = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getReports: ReportAPI.get(builder),
    getReportById: ReportAPI.getById(builder),
    addReport: ReportAPI.add(builder),
    updateReport: ReportAPI.updateById(builder),
    deleteReport: ReportAPI.deleteById(builder),
    getEquipments: EquipmentAPI.get(builder),
    getEquipmentById: EquipmentAPI.getById(builder),
    addEquipment: EquipmentAPI.add(builder),
    updateEquipment: EquipmentAPI.updateById(builder),
    deleteEquipment: EquipmentAPI.deleteById(builder),
    getFounds: FoundAPI.get(builder),
    getFoundById: FoundAPI.getById(builder),
    addFound: FoundAPI.add(builder),
    updateFound: FoundAPI.updateById(builder),
    deleteFound: FoundAPI.deleteById(builder),
    getLogBooks: LogBookAPI.get(builder),
    getLogBookById: LogBookAPI.getById(builder),
    addLogBook: LogBookAPI.add(builder),
    updateLogBook: LogBookAPI.updateById(builder),
    deleteLogBook: LogBookAPI.deleteById(builder),
    getServiceType: ChartAPI.getServiceType(builder),
    getCustomerAppointment: ChartAPI.getCustomerAppointmentType(builder),
    getLogBookReport: ChartAPI.getLogbookReport(builder),
    getEquipmentReport: ChartAPI.getEquipmentReport(builder),
    getAppointmentReport: ChartAPI.getAppointmentReport(builder),
    getAppointmentSale: ChartAPI.getAppointmentSale(builder),
    getDeliveryReport: ChartAPI.getDeliveryReport(builder),
    getProductType: ChartAPI.getProductType(builder),
    getScheduleType: ChartAPI.getScheduleType(builder),
    getCommentRating: ChartAPI.getCommentRating(builder),
    getTransactionPayment: ChartAPI.getTransactionPayment(builder),
    getFeedbackReport: ChartAPI.getFeedbackReport(builder),
