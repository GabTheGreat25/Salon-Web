...
import { useGetReportByIdQuery } from "@api";
...
export default function () {
  ...
  const randomImage =
  report?.equipment?.image?.length > 0
    ? report?.equipment?.image[Math.floor(Math.random() * report?.equipment?.image?.length)]
    : null;
                ...
                <label className="block">
                  ...
                  <label className="block">
                    ...
                    <input
                      ...
                      readOnly
                      value={
                        new Date(report?.date_missing).toISOString().split("T")[0]
                      }
                      className="block mb-2 ml-6 xl:text-lg md:text-[1rem]  border-0 bg-card-input dark:border-dark-default focus:ring-0 focus:border-secondary-t2 focus:dark:focus:border-secondary-t2 dark:placeholder-dark-default w-full"
                    />
                  </label>
                  ...
                  <label className="block">
                    <span className="xl:text-xl md:text-[1rem] font-semibold">
                      Inital Loss Quantity:
                    </span>
                    <input
                      value={report?.initial_qty}
                      className="block mb-2 ml-6 xl:text-lg md:text-[1rem]  border-0 bg-card-input dark:border-dark-default focus:ring-0 focus:border-secondary-t2 focus:dark:focus:border-secondary-t2 dark:placeholder-dark-default w-full"
                    />
                  </label>
                  <label className="block">
                    <span className="xl:text-xl md:text-[1rem] font-semibold">
                     Current Loss Quantity:
                    </span>
                    <input
                      value={report?.loss_qty}
                      className="block mb-2 ml-6 xl:text-lg md:text-[1rem]  border-0 bg-card-input dark:border-dark-default focus:ring-0 focus:border-secondary-t2 focus:dark:focus:border-secondary-t2 dark:placeholder-dark-default w-full"
                    />
                  </label>
                  <label className="block">
