...
export default function () {
  ...
  return (
    <>
      <section className="flex flex-col justify-between min-h-screen p-6 m-6 border-2 rounded-lg border-dark-default dark:border-light-default">
        <div>
          ...
          <p className="mb-4 text-4xl font-normal text-justify">
            ...
            Beauty Lounge, located at 22 Calleja Steet Central Signal Village
            1630 Taguig, Philippines. Before proceeding with the services, I
            have read and understood the terms of this waiver agreement.
          </p>
          <p className="mb-4 text-4xl font-normal text-justify">
            Ingredients Disclosure:
            <br /> I understand that the products and materials used in the
            salon may contain various ingredients, including but not limited to
            ...
            information about the ingredients upon request. The salon is not
            liable for any adverse reactions or consequences arising from
            undisclosed allergies.
          </p>
          <p className="mb-4 text-4xl font-normal text-justify">
            Salon's Limited Liability:
            <br /> I understand and agree that Lhanlee Beauty Lounge and its
            staff are not liable for any injuries, damages, or losses that may
            occur during or as a result of the services provided. This includes
            but is not limited to allergic reactions, skin irritations, or
            injuries resulting from negligence. I release Lhanlee Beauty Lounge
            and its staff from any liability arising from the services rendered.
          </p>
          <p className="mb-4 text-4xl font-normal text-justify">
            Assumption of Risk:
            ...
            salon services and waive any claims against Lhanlee Beauty Lounge
            and its staff for any injuries or damages incurred. Signature: By
            signing below, I acknowledge that I have read, understood, and agree
            to the terms of this waiver agreement. I consent to receive salon
            services knowing the risks involved.
          </p>
