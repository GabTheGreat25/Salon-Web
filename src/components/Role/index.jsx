...
export default function ({
  ...
  return (
    <div className="grid grid-flow-row-dense my-24">
      <div className="mt-24 rounded-lg bg-primary-t2">
        ...
        <div className="items-center px-3 pt-6 pb-3 rounded-b-lg text-dark-default bg-light-default dark:bg-dark-default">
          ...
          <span className="grid items-center justify-center py-6">
            <button
              ...
              className="xl:px-6 lg:px-4 md:px-2 font-medium capitalize rounded-lg 2xl:text-xl xl:text-base md:text-[.75rem] btn btn-primary text-light-default dark:text-dark-default"
            >
              {buttonTitle}
            </button>
          </span>
