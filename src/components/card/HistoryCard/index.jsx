    ...
    return(
        ...
        <div className="p-4 w-full h-full bg-white m-4 text-black rounded-lg shadow-lg items-center space-x-4">
            <div class="flex justify-between items-center space-x-4 border-b border-gray-300 w-full"> 
                ...
                <h3 className="bg-gray-400 rounded-full p-2 text-white text-xs">{data.status    }</h3>
            </div>
        ...
        <div className="border-t m-2 text-right border-gray-300 w-full">
            ...
            <button className="bg-pink-400 rounded-xl p-2 text-white text-xs m-2 w-16">Rate</button>
            <button className="bg-transparent rounded-xl p-2 text-black border border-gray-900 text-xs m-2 w-24">Appoint Again</button>
        </div>
        </div>
        </>
    )
